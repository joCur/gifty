    ...
    <div className="space-y-8 lg:space-y-10">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          {/* Invisible user indicator to prevent hydration mismatch - DO NOT REMOVE
              Without this, React hydration doesn't preserve the isOwner conditional */}
          <span className="text-[0px] opacity-0 absolute pointer-events-none" aria-hidden="true">
            {user?.id}
          </span>
